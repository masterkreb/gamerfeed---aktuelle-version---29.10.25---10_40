...
export const Header: React.FC<HeaderProps> = ({ theme, setTheme, viewMode, setViewMode, isRefreshing, onRefresh, onOpenSettings, onLogoClick, newArticlesCount }) => {
          ...
          >
            ...
            {newArticlesCount > 0 && (
                <span
                  ...
                  className="absolute -top-1 -right-1 flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-red-600 rounded-full animate-pop-in"
                  aria-label={`${newArticlesCount} new articles`}
                >
                  {newArticlesCount}
                </span>
            )}
